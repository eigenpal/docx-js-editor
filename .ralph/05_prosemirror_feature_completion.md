...
- **SuperDoc style engine**: `reference/superdoc/packages/layout-engine/style-engine/`
- **SuperDoc table handling**: `reference/superdoc/packages/super-editor/src/extensions/`
...
- [x] **Task 5: Add table nodes to schema**
  ...
  - Reference: SuperDoc table nodes
...
- Check SuperDoc for concepts, but write clean-room implementations
