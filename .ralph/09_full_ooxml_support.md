...
- [ ] **4.1 Editable text boxes** — New `TextBoxExtension` as isolating block node with `content: '(paragraph|table)+'`. Positioned absolutely. Focus management between main doc and text box. Round-trip `wps:wsp`/`wps:txbx` XML.
